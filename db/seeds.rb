...
pitches = [
  {headline: "I'm awesome", :email => "roneesh@gmail.com", :title => "Chief of Procurement"},
  {headline: "I'm just ok", :email => "joengo83@gmail.com", :title => "Chief of Procurement"},
  {headline: "I'm not so great", :email => "jbh5079@gmail.com", :title => "Chief of Procurement"},
  {headline: "I'm overrated", :email => "k8hoolihan@gmail.com", :title => "Chief of Procurement"}
  ]
